...
# Test data
predicttest1<-predict(m1,df_test)
predicttest1

predicttest2<-predict(m2,df_test)

?predict()

rmse(df_test$CHI_MLU[!is.na(df_test$CHI_MLU)], predicttest1)

rmse(df_test$CHI_MLU[!is.na(df_test$CHI_MLU)], predicttest2)
