...
p<-predict(m1, bernie)
p[6]
bernie$CHI_MLU[6]-p[[6]]
#Bernie is below expectations 

model_td<-lmer(CHI_MLU~Visit*verbalIQ1+(1+Visit|Child.ID),td)
model_td
pb<-predict(model_td, bernie)

bernie$CHI_MLU[6]-pb[[6]]


model_asd<-lmer(CHI_MLU~Visit*verbalIQ1+(1+Visit|Child.ID),asd)

pa<-predict(model_asd, bernie,allow.new.levels=TRUE)

bernie$CHI_MLU[6]-pa[[6]]
```
